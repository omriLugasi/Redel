...
describe('Pending plugin', () => {
  ...
  context('Pending Request check exists in main module', () => {
  ...
  context('basic pending logic', () => {
    ...
    it('should validate assignment of request', done => {
  ...
  context('is two request with the same url and params', () => {
    ...
    it('should validate that it should work well', done => {
  ...
  context('Working well under pressure', () => {

    it('should check if the plugin work under pressure', done => {
